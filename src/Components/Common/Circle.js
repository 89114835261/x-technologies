...
const Circle = (props) => {
    return(
        ...
        <circle cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke={props.colorOne} stroke-width="6" stroke-dasharray={`${props.number} ${100 - props.number}`} stroke-dashoffset="25"></circle>
    </svg>
    )
}
